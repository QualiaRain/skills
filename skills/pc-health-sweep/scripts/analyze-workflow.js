...
<what the owner actually reported today, in their words, numbered>
...
if (DIR.startsWith('SET_ME')) throw new Error('Set DIR (or export PC_HEALTH_DIAG_DIR) to the collect.ps1 output folder before launching.')
